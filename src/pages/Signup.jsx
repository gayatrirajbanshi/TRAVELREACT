...
export default function Signup() {  
  ...
  return (
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-96 p-4 border-1 rounded-md">
            <div className="mb-6 flex justify-between items-center">
            <div>
            <h1 className="text-2xl font-bold">Register</h1>
            <p className="text-xs text-gray-400">Fill details to create a new account  </p>
            </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="email" placeholder="abc@.com" {...field} />
              </FormControl>
