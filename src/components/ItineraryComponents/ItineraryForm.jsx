...
const itinerarySchema = z.object({
    ...
    activities: z.string(activitySchema).min(1, "At least one activity is required"),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Day 2 - Exploring Paris" {...field} />
                  </FormControl>
                   <FormDescription>Give this day a memorable title</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Describe any additional details about this day..." rows={3} {...field}/>   
                  </FormControl>
                  <FormDescription>Add any additional details about this day</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
  ...
  return (
    <div className="border rounded-lg p-4 space-y-4 bg-gray-50">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <FormField 
        control={form.control}
        name={`ativites.${activityIndex}.name`}
        render={({ field }) => (
