...
import { Calendar, Calendar1, Plane, Star, Users } from 'lucide-react'
        ...
        <section>   
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
              ...
              data.map ((trip) => {
                ...
                return (
                  <Card key= {trip._id} className="overflow-hidden hover:shadow-lg trasition-shadow">
              ...
              <CardContent>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="text-right">
                    <span className="text-2xl font-bold text-blue-600">${trip.budget.total}</span>
